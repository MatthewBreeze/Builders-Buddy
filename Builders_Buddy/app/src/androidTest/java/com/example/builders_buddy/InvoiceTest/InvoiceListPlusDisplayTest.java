...
public class InvoiceListPlusDisplayTest {
...
//                        isDisplayed()));
//        textView5.check(matches(withText("Toms House")));
        ...
        ViewInteraction textView10 = onView(
                allOf(withId(R.id.name), withText(" Toms House"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView10.check(matches(withText(" Toms House")));
        ...
        ViewInteraction textView11 = onView(
                allOf(withId(R.id.manHours), withText(" Man Hours :12"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView11.check(matches(withText(" Man Hours :12")));
