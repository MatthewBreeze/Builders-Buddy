        ...
        ViewInteraction textView = onView(
                allOf(withText("Receipts"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Receipts")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.totalValue), withText("                    April            Total : £2716.99"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                2),
                        isDisplayed()));
        textView2.check(matches(withText("                    April            Total : £2716.99")));
